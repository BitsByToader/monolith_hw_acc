...
module m31_adder (
    ...
    localparam int OUT_WIDTH = outputs.OUTPUT_DATA_WIDTH;

    mod_reduction_inout_if #(.DATA_WIDTH(OUT_WIDTH)) reduce_in();
    mod_reduction_inout_if #(.DATA_WIDTH(OUT_WIDTH)) reduce_out();
